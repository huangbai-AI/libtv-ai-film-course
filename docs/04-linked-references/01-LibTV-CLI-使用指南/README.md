> 来源：[飞书原文](https://resonate.feishu.cn/wiki/RjelwT2UoidnTMka2nCc2chGnud)  
> 同步时间：2026-08-16T09:01:04.604Z  
> 文档标识：BtfQdfawgoxUGRxxHVucEnbgnZn
...
<sheet sheet-id="1p6Y6G" token="NQ8AsTL8ahh1xNt79l2c2oBZnBh"></sheet>
...
![图片展示了LibTV界面及浏览器页面。右侧浏览器页面中，账号信息部分有一个红色方框突出显示的内容。结合上下文，此图片用于说明在浏览器中切换账号或空间对CLI登录状态等的影响，建议在切换到期望的账号和空间后再进行CLI登录或重新登录，可将「个人ID」或「团队ID」复制给Agent核对状态，红色方框突出部分或与账号、空间相关信息的切换或查看有关。](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=MmJmNmVjNTIxZTM2ZmM5ZGJlY2U2MjZiMTM1NmYwNTNfYjJiMjkyOTRjNDZhYzlhZTMzNDk1ODYwNzM4OTNlYjdfSUQ6NzY0NDg2MTIxNDk0NjY3NTkwMl8xNzg2ODcxMjUxOjE3ODY4NzQ4NTFfVjM)




![图片图片 自动生成图片描述](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=YzA3ZWMxODFlNDYwZTA4OThlMjcwMWRjMmZhMWUyMGZfNWE5YjVmYjZjMGJlMDA0YWVlMjgyYTVjZTEzMjM5OTZfSUQ6NzY0NDg2MTIxNTA1MTE4OTQ2NV8xNzg2ODcxMjUxOjE3ODY4NzQ4NTFfVjM)
...
- [image.png](./assets/XL6obDTllo5RKuxD3uVcK4dlntd.png)（media，347006 字节）
- [img_v3_02124_e0aab762-8df1-410d-90e4-c61157ae102g.jpg](./assets/TF2SbhLKUof8JNxksqrcu9Q5nDe.jpg)（media，106566 字节）
